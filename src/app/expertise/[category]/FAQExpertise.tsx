...
const BackgroundSpiral = memo(({ isDark }: { isDark: boolean }) => (
  <div
    className={cn(
      "absolute left-[-100px] -top-[50px] w-[300px] h-[400px]",
      "animate-fade-in-up opacity-20",
      "pointer-events-none"
    )}
    style={{
      background: `conic-gradient(from 0deg at 50% 50%, ${isDark ? '#E0FF5C' : '#9FB832'} 0deg, transparent 360deg)`,
      borderRadius: '50%',
      filter: 'blur(40px)'
    }}
    aria-hidden="true"
