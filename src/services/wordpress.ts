...
// Function to fetch posts from WordPress REST API with pagination
export async function getLatestPosts(count: number = 10, page: number = 1): Promise<{ posts: WordPressPost[]; total: number; totalPages: number }> {
  try {
