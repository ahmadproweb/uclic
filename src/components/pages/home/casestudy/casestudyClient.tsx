            ...
            >
              <div className={cn(
                ...
                {portfolio.featuredImage?.node.sourceUrl && (
                  <img
                    src={`${portfolio.featuredImage.node.sourceUrl.replace(/\.(jpg|jpeg|png|gif)$/, '-400x250.$1')}.webp`}
                    alt={portfolio.title}
              ...
              <div 
                className="text-sm md:text-base mb-6 md:mb-8 flex-1 transition-colors duration-300"
              >
                {portfolio.excerpt.replace(/<[^>]*>/g, '')}
              </div>
              <div className={cn(
