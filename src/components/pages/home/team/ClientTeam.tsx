        ...
        <div className="relative w-16 md:w-24 flex-shrink-0">
          ...
          <div className={cn(
            ...
            {member.equipeFields.linkedin && (
              <SocialIcon href={member.equipeFields.linkedin} backgroundColor={themeColors.primary.main}>
            ...
            {member.equipeFields.twitter && (
              <SocialIcon href={member.equipeFields.twitter} backgroundColor={themeColors.primary.main}>
                <svg className="w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24" fill="none">
            ...
            {member.equipeFields.autre && (
              <SocialIcon href={member.equipeFields.autre} backgroundColor={themeColors.primary.main}>
                <svg className="w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24" fill="none">
