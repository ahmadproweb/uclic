...
import { fetchTeamData, TeamMember } from '@/lib/wordpress';
          ...
          {teamMembers.map((member) => (
            ...
            >
              <div className="relative w-16 md:w-24 flex-shrink-0">
                <img
                  src={member.equipe.image?.node.sourceUrl || "https://media.istockphoto.com/id/1919265357/fr/photo/portrait-en-gros-plan-dun-homme-daffaires-confiant-debout-dans-son-bureau.jpg?s=612x612&w=0&k=20&c=u_cAYkuDe1e8oeBrKBNLbPiBrZ_fflqLhwxIXXlgsOg="}
                  alt={member.title}
                  className={cn(
                ...
                {hoveredId === member.slug && (
                  <div className="absolute -right-2 md:-right-4 top-0 flex flex-col gap-2 md:gap-3">
                    {member.equipe.linkedin && (
                      <SocialIcon href={member.equipe.linkedin}>
                    ...
                    {member.equipe.twitter && (
                      <SocialIcon href={member.equipe.twitter}>
                        <svg className="w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24" fill="none">
                    ...
                    {member.equipe.autre && (
                      <SocialIcon href={member.equipe.autre}>
                        <svg className="w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24" fill="none">
