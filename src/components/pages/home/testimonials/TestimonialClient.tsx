  ...
  ({
    ...
    <header className="text-center mb-12 md:mb-16 animate-fade-in-up">
      ...
      >
        ...
        <br />
        aux tips Growth & IA de Wladimir
      </h2>
      ...
      >
        Fondateur d'Uclic, Wladimir partage quotidiennement ses stratégies de
        croissance et d'automatisation IA sur LinkedIn. Ci-dessous, découvrez
        les{" "}
        <strong
          className={cn("font-semibold", isDark ? "text-white" : "text-black")}
        >
          réactions vérifiées de CMOs, founders et Growth Hackers
        </strong>{" "}
        qui appliquent ses conseils — chaque commentaire est cliquable.
      </p>
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="inline-flex px-3 py-1 bg-[#1DB954]/20 border border-[#1DB954]/30 rounded-full mb-3">
          <span className="text-[#1DB954] font-semibold text-xs">
            🎙️ Podcast Spotify
          </span>
        </div>
        <h3
        ...
        >
          Wladimir Delcros avec Alexandre Brengues : Automatiser à 100% sa Lead
          Generation B2B
        </h3>
        <p
          className={cn(
        ...
        >
          Head of Growth chez CodinGame partage tout son workflow
          d'automatisation avec des outils No-Code avec Alexandre Brengues (Wild
          Marketer). 1h06 de stratégies actionnables.
        </p>
  ...
  <div className="mb-4 break-inside-avoid animate-fade-in-up">
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          Wladimir Delcros avec Benoit Dubos : Contacter les prospects au bon
          moment
        </h3>
        <p
          className={cn(
        ...
        >
          Wladimir Delcros et Benoit Dubos (Scalezia) partagent leurs stratégies
          pour automatiser votre prospection et contacter vos leads au moment
          optimal.
        </p>
        ...
        <div className="mb-4">
          {(() => {
            const LazyYouTube =
              require("../../../optimization/LazyYouTube").default;
            return (
              <LazyYouTube
                videoId="GRlZO8KtB7A"
  ...
  <div className="mb-4 break-inside-avoid animate-fade-in-up">
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          Jean Bonnenfant partage son retour d'expérience sur l'expertise de
          Wladimir en automatisation et Growth Marketing.
        </p>
        ...
        <div className="mb-4 rounded-2xl overflow-hidden">
          ...
          {(() => {
            const LazyVideo =
              require("../../../optimization/LazyVideo").default;
            return (
              <LazyVideo
  ...
  <div className="mb-4 break-inside-avoid animate-fade-in-up">
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          Le CEO de La Growth Machine partage son retour d'expérience sur
          l'expertise de Wladimir en automatisation et Growth.
        </p>
