...
export default function ToolboxPage({ 
  ...
  if (!toolboxPosts || toolboxPosts.length === 0) {
    return <div className="text-center py-20 text-black">Aucun outil trouvé.</div>;
  }
      ...
      <div className="max-w-[1250px] mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h1 className={cn(
            ...
            Découvrez notre sélection<br/>d'outils pour startups
          </h1>
          <div className={cn(
          ...
          <p className={cn(
            ...
            Des ressources essentielles pour<br/>développer votre entreprise
          </p>
        </div>
